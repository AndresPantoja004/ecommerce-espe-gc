...
export class CategoryMenu extends LitElement {
    static styles = css`
        ...
        .category-overlay {
            ...
            inset: 0;
            border-radius: 50%;
            background-color: var(--category-overlay-color);
            opacity: 0;
    ...
    @property({ type: String }) overlayColor = 'rgba(0, 0, 0, 0.3)';
    @property({ type: String }) textColor = '#ffffff';
    @property({ type: String }) labelBgColor = 'rgba(0, 0, 0, 0.6)';
    ...
    return html`
        <div
            ...
            style="
                --category-overlay-color: ${this.overlayColor};
                --category-text-color: ${this.textColor};
                --category-label-bg: ${this.labelBgColor};
            "
        >
        ${this.categories.map(
            (cat) => html`
