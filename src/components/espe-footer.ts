...
export class EspeFooter extends LitElement {
  ...
  @property({ type: Array }) contacts: string[] = [];
  @property({ type: Array }) paymentLogos: string[] = [];
        ...
        return html`
            <footer>
                ...
                <div class="payment-methods">
                    ${this.paymentLogos.map((src) => html`<img src="${src}" alt="Método de pago" />`)}
                </div>
                </div>
            </footer>
        `;
